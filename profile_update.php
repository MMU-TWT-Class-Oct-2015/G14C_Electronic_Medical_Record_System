...
<?php
include_once('data_connect.php');  //Connect mysql database
$result ="";
$result = mysql_query("select first_name from accounts ORDER BY first_name");
?>
...
<TBODY>
<TR>
<TD class=sectionhead align=middle colSpan=2><div align="center">Account Type to fetch details !</div>
</TD>
</TR>
<TR>
...
<select name="first_name" tabindex="1">
